...
const availableWeekValidate = z.string().refine((val) => {
...
const specificDatesValidate = z.string().refine((val) => {
  ...
  message: "形式は 'YYYY-MM-DD' または 'YYYY-MM-DD&HH:mm-HH:mm' で入力してください",
});
