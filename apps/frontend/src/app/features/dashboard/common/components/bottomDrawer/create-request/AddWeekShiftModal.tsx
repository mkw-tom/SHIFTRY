				...
				<div className="py-4 w-full">
					...
					>
						...
						<div className="w-2/3 flex items-center gap-1 ml-auto mb-5">
							<button
								type="button"
								className="btn btn-sm border-buttom bg-gray02 border-none w-1/3 text-white"
										...
										{edit.status && edit.idx === idx ? (
											...
											>
												...
												<div className="flex items-center gap-1 ml-auto w-2/3">
													<button
														type="button"
														className="btn btn-sm w-1/3 bg-gray02 border-none"
														onClick={() => closeEdit()}
													>
														中止
													</button>
													<button
														type="button"
														className="btn btn-sm bg-green03 text-green02 w-2/3 border-none"
											...
											>
												...
												<div className="flex items-center gap-1 ml-auto">
													<button
														type="button"
														className="btn btn-xs bg-gray02 border-none text-white"
														onClick={() =>
													...
													<button
														type="button"
														className="btn btn-xs bg-blue01 border-none text-white"
														onClick={() =>
															setEdit((prev) => ({
																...prev,
																status: true,
